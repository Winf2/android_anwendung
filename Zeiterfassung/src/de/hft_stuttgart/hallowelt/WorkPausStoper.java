...
public class WorkPausStoper extends AsyncTask<Integer, Integer, Integer> {
...
//    private static final String METHOD_NAME = "halloSoap";
    ...
    private static final String SOAP_ACTION = "http://193.196.143.148/soap/stopPauseWork";
    private static final String NAMESPACE = "urn:dajana";
    private static final String METHOD = "stopPauseWork";
